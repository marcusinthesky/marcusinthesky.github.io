...
- Read the nearest `README.md` for commands and the nearest `ARCHITECTURE.md` for design rationale.
- Public content must never contain an email address, phone number, street address, or professional references.
- Keep ordinary pages static. Add `"use client"` only when browser state is essential.
