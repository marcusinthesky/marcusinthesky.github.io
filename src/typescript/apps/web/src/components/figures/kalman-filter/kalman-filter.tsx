...
import styles from "./kalman-filter.module.css";
...
export function KalmanFilter() {
  ...
  return (
    ...
    >
      ...
      <g className={styles.reveal} style={timelineStep(introDelay, revealDuration)}>
      ...
      <path
        className={`${styles.fade} fill-none stroke-muted-foreground`}
        d={kalmanLatentPath}
