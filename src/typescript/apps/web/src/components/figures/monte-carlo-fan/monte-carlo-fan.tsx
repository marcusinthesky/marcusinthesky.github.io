...
import styles from "./monte-carlo-fan.module.css";
  ...
  return (
    <div>
      ...
      >
        ...
        <g
          aria-hidden="true"
          className={`${styles.walks} ${styles.fade} fill-none stroke-border`}
          strokeWidth="0.75"
        ...
        <g
          className={`${styles.reveal} fill-foreground`}
          style={timelineStep(summaryDelay, fadeDuration)}
        >
        ...
        <g
          aria-hidden="true"
          className={`${styles.reveal} fill-muted-foreground font-sans text-[11px] tabular-nums`}
