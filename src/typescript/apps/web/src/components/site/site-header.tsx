...
// to with data-nav, and site-header.module.css draws that item's thread (keep in step).
const navigation = [
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border bg-background">
      ...
      >
        ...
        <nav aria-label="Menu" className={`${styles.nav} page-shell`}>
            ...
            {navigation.map(({ chapter, href, label, section }) => (
              ...
              >
                ...
                >
                  ...
                  <span
                    aria-hidden="true"
                    className="absolute -bottom-px left-0 h-0.5 w-12"
                    data-part="thread"
                  />
                </Link>
              </li>
